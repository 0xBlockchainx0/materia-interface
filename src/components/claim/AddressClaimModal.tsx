...
import theme, { TYPE, ExternalLink, CloseIcon, CustomLightSpinner, UniTokenAnimated, SecondaryPanelBoxContainer, SecondaryPanelBoxContainerExtraDecorator, SimpleTextParagraph } from '../../theme'
      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim GIL Token</TYPE.white>
