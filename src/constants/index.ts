...
export const MIN_GIL_UNLOCK_FULL_BATCHSWAP = JSBI.BigInt(50000000000000000000000000000000000000000000000000000 * 10 ** 18)
export const MIN_GIL_UNLOCK_FULL_BATCHSWAP_TEXT = "1000"
// export const MIN_IGIL_UNLOCK_FULL_BATCHSWAP = JSBI.BigInt(1000 * 10 ** 18)
export const MIN_IGIL_UNLOCK_FULL_BATCHSWAP = JSBI.BigInt(50000000000000000000000000000000000000000000000000000 * 10 ** 18)
