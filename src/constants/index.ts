...
export const MATERIA_BATCH_SWAPPER_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0xe64665ED0f7769968FB13Df884dEDC10AE5EC7d9',
  [ChainId.RINKEBY]: ZERO_ADDRESS,
  [ChainId.ROPSTEN]: '0xe64665ED0f7769968FB13Df884dEDC10AE5EC7d9',
  [ChainId.GÖRLI]: ZERO_ADDRESS,
  [ChainId.KOVAN]: ZERO_ADDRESS
}

export const DEX_BATCH_SWAPPER_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0xF9597cC4b3c8df29d6Da2e374FF9533487351C69',
  [ChainId.RINKEBY]: ZERO_ADDRESS,
  [ChainId.ROPSTEN]: '0xF9597cC4b3c8df29d6Da2e374FF9533487351C69',
  [ChainId.GÖRLI]: ZERO_ADDRESS,
  [ChainId.KOVAN]: ZERO_ADDRESS
}
